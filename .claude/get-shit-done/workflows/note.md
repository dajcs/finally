...
- **Global scope**: `/mnt/c/Users/dajcs/code/finally/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/mnt/c/Users/dajcs/code/finally/.claude/notes/`)
...
2. Glob `/mnt/c/Users/dajcs/code/finally/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/mnt/c/Users/dajcs/code/finally/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/mnt/c/Users/dajcs/code/finally/.claude/notes/` — works in any directory
