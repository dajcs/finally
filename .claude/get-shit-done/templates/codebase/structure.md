...
- Usage: Reference from command with `@/mnt/c/Users/dajcs/code/finally/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /mnt/c/Users/dajcs/code/finally/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /mnt/c/Users/dajcs/code/finally/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
